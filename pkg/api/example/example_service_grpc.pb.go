...
const (
	Example_CreatePost_FullMethodName = "/github.com.PavelNen.grpc.api.example.Example/CreatePost"
	Example_ListPosts_FullMethodName  = "/github.com.PavelNen.grpc.api.example.Example/ListPosts"
)
...
var Example_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.PavelNen.grpc.api.example.Example",
